...
class Constants {
  ...
  static const Color BUTTON_COLOR = const Color(0xDD000000);

  static const Color BUTTON_TEXT_COLOR = const Color(0xFF757575);

  static const Color SYSTEM_BUTTON_COLOR = const Color(0xFF2dc421);

  static const Color SYSTEM_BUTTON_RESET_COLOR = const Color(0xffff0000);
}
